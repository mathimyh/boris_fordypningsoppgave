...
def magnon_dispersion_relation(meshdims, t, damping, x_start, x_stop, MEC, ani, dir):
...
def phonon_dispersion_relation(meshdims, t, damping, x_start, x_stop, MEC, ani, dir):
    dir1 = 0
